...
button.addEventListener("click", function () {
    ...
    setTimeout(() => {
        ...
        window.location.href = "./conchosss/conchosss.html";
    }, 200);
});
...
function progressInterva() {
    ...
    if (count === 100 && percentWidth === 100) {
        ...
        // const offset = (percentWidth / 100) * (barWidth - heartBox.offsetWidth);
        // heartBox.style.left = `${offset}px`; 
